...
|---|---|---|
| Teammate A | `<Tim Ruland>` | `<LPTimey>` |
| Teammate B | `<Marc Obst>` | `<TirmaoHackathon>` |
...
|---|---|---|---|---|
| 3 | `design-done` | Design system + voice (DESIGN.md) | **ALL** | `All` |
| 4 | `data-model` | Task model + board view | **ALL** | `All` |
| 5 | `crud-modal` | Add / edit / delete modal | **ALL** | `All` |
| 6 | `tag-style` | Feature / bug colors | **ALL** | `All` |
| 7 | `task-owner` | Owner indicator + handoff | **ALL** | `All` |
| 8 | `due-tint` | Due-date color tinting | **ALL** | `All` |
| 9 | `context` | Context field on the task modal | **ALL** | `All` |
| 10 | `copy-prompt` | "Copy as Prompt Context" button | **ALL** | `All` |
| 11 | `anchors` | Deliverable Anchor Board | **ALL** | `All` |
| 12 | `secret-sauce` | The one thing that makes it yours | **All** | `All` |
...
- **Team name:** `Laguna Lo-Fi`
- **Tagline (one sentence):** `lieber Arm dran als Arm ab`
- **Tracker URL after deploy:** `[git](https://github.com/TirmaoHackathon/vibecoding-project-tracker.git)` (Vercel will give it to you)
